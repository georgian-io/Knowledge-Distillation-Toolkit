...
from fairseq_mod.criterions.cross_entropy import CrossEntropyCriterion
from fairseq_mod.criterions.label_smoothed_cross_entropy import LabelSmoothedCrossEntropyCriterion
