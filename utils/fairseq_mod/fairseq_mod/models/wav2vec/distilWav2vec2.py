...
"""
Distill the wav2vec 2.0 model by using masked representations, similar to DistilBERT.
"""
...
class DistilWav2Vec2Model(BaseFairseqModel):
    ...
    def forward(self, source, padding_mask=None, mask_indices=None, mask_channel_indices=None, mask=True, features_only=False, neg_idxs=None, temperature=1):
        ...
        if features_only:
            return {"x": x, "padding_mask": padding_mask, "prob":token_prob, "log_prob":token_log_prob,
                    "cnn_time":cnn_time, "encoder_time":encoder_time, "between_cnn_encoder_time":between_cnn_encoder_time, "conv_time":cnn_time, "max_pool_time":0}
        ...
        #mask_rep_log_prob = torch.log(mask_rep_prob)

        result = {"x": x, "padding_mask": padding_mask, "loss":{"features_pen": features_pen},
                  "logits": x, "prob": mask_rep_prob, "log_prob": mask_rep_log_prob}
...
@register_model_architecture("distilWav2vec2", "distilWav2vec2")
