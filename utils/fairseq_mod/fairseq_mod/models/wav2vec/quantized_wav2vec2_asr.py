...
from fairseq_mod import checkpoint_utils, tasks, utils
...
from fairseq_mod.modules import LayerNorm, PositionalEmbedding, TransformerDecoderLayer
...
def add_common_args(parser):
    ...
    parser.add_argument(
        ...
        default=32,
        type=int,
        help="dimension of the first layer of the decoder in wav2vec 2.0",
    )
    ...
    parser.add_argument(
        ...
        default=32,
        type=int,
        help="dimension of the last layer of the encoder in wav2vec 2.0",
    )

@register_model("quantized_wav2vec_ctc")
...
@register_model_architecture("quantized_wav2vec_ctc", "quantized_wav2vec_ctc")
