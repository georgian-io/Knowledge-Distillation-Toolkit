...
from fairseq_mod import checkpoint_utils, distributed_utils, models, optim, utils
from fairseq_mod.file_io import PathManager
from fairseq_mod.logging import meters, metrics
from fairseq_mod.nan_detector import NanDetector
from fairseq_mod.optim import lr_scheduler
...
class Trainer(object):
    ...
    def train_step(self, samples, raise_oom=False, compression_scheduler=None, epoch=None, minibatch_id=None, minibatches_per_epoch=None):
            ...
            try:
                with maybe_no_sync():
                    ...
                    loss, sample_size_i, logging_output = self.task.train_step(
                        ...
                        epoch=epoch, minibatch_id=minibatch_id, minibatches_per_epoch=minibatches_per_epoch
                    )
                    del loss
        ...
        try:
            ...
            #compression_scheduler.on_minibatch_end(epoch, minibatch_id=minibatch_id, minibatches_per_epoch=minibatches_per_epoch)
    ...
    def get_meter(self, name):
        ...
        from fairseq_mod import meters
