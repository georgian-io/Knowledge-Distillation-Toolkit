...
from fairseq_mod.modules import TransformerSentenceEncoder
from fairseq_mod.modules.sparse_transformer_sentence_encoder_layer import SparseTransformerSentenceEncoderLayer
