...
from fairseq_mod.logging.meters import safe_round
from fairseq_mod.modules import gelu, gelu_accurate
from fairseq_mod.modules.multihead_attention import MultiheadAttention
...
def load_ensemble_for_inference(filenames, task, model_arg_overrides=None):
    from fairseq_mod import checkpoint_utils
