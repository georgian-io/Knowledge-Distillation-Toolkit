...
from fairseq_mod.dataclass.data_class import (
    CheckpointParams,
    CommonEvalParams,
    CommonParams,
    DatasetParams,
...
from fairseq_mod.utils import csv_str_list, eval_bool, eval_str_dict, eval_str_list  # noqa
...
def parse_args_and_arch(
    ...
    from fairseq_mod.models import ARCH_MODEL_REGISTRY, ARCH_CONFIG_REGISTRY, MODEL_REGISTRY
    ...
    from fairseq_mod.registry import REGISTRIES
    ...
    if hasattr(args, "task"):
        from fairseq_mod.tasks import TASK_REGISTRY

        TASK_REGISTRY[args.task].add_args(parser)
    if getattr(args, "use_bmuf", False):
        # hack to support extra args for block distributed data parallelism
        from fairseq_mod.optim.bmuf import FairseqBMUF
...
def add_model_args(parser):
    ...
    from fairseq_mod.models import ARCH_MODEL_REGISTRY
