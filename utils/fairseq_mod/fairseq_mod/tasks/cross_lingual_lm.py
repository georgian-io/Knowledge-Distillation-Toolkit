...
from fairseq_mod.data.legacy.masked_lm_dictionary import MaskedLMDictionary
...
from fairseq_mod.data.multi_corpus_sampled_dataset import MultiCorpusSampledDataset
