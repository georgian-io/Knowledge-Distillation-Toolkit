...
# to build them here
try:
    import fairseq_mod.data.token_block_utils_fast  # noqa
except ImportError:
    try:
        import cython  # noqa
        import os
...
from fairseq_mod.hub_utils import BPEHubInterface as bpe  # noqa
from fairseq_mod.hub_utils import TokenizerHubInterface as tokenizer  # noqa
from fairseq_mod.models import MODEL_REGISTRY  # noqa
